...
public class AddTransactionDialogFragment extends DialogFragment {
    ...
    interface AddTransactionDialogListener {
        void onDialogPositiveClick_AddTransaction(DialogFragment dialog,
                                   String title,
                                   String category,
                                   String amount);
    }
    ...
    public Dialog onCreateDialog(Bundle savedInstance) {
        ...
        LayoutInflater inflater = LayoutInflater.from(getActivity()); builder.setTitle(R.string.title_dialog_add);
